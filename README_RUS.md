...
Если какое-либо из перечисленных в конфигурационном файле действий не указано ни в одном из стадий pipeline'а (или не
передано переменной в описании стадий), то это действие будет проигнорировано.
